...
import com.example.rapcbo.sy.MainActivity.MainActivity;
import com.example.rapcbo.sy.R;
import com.example.rapcbo.sy.Show.Comment;
import com.example.rapcbo.sy.Show.CommentListAdapter;
...
public class ViewCommentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mCheckMark = (ImageView) view.findViewById(R.id.ivPostComment3);
    ...
    private void setupWidgets(){
        ...
        mCheckMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(mContext, "dvfdbfdhbfdnhgdngdg", Toast.LENGTH_SHORT).show();
